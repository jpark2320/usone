...
class CreateNewItem extends React.Component<ICreatePostProps, any>  {
  ...
  public render() {
    ...
    return (
      <div >
         <Button className={classes.button }onClick={this.handleClickOpen} variant="outlined" color="primary" aria-label="Add" >
         글쓰기
        </Button>
        ...
        >
          <DialogTitle id="responsive-dialog-title">{" OOO게시판 글쓰기"}</DialogTitle>
            <DialogContent>
...
export default withMobileDialog({breakpoint: 'sm'})(withStyles(styles)(CreateNewItem));
