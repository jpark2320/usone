          ...
          <Paper className={classes.root} elevation={1}>
            <Grid  container={true} spacing={24}>
              ...
              <Grid className={classes.gridPadding} item={true} xs={6} sm={6} >
                ...
                <Grid className={classes.gridPadding} item={true} xs={6} >
                      ...
                      <FormControlLabel
                        ...
                        label="광고문의"
                      />
                  <FormHelperText>선택된 게시판들이 우선적으로 홈페이지에 등장합니다.</FormHelperText>
              </Grid>
              </FormGroup>
              </FormControl>
              ...
              <Grid item={true} xs={12}>
                <FormControlLabel
                  control={<Checkbox  color="primary" name="optEmail" value="yes" />}
                  label="개인 이메일로 최신 정보 및 댓글을 알림받습니다."
                />
              </Grid>

              <Grid item={true} className={classes.childCenterAlign}  xs={12}>
                  <Button onClick={this.props.changeToEditView} className={classes.button}><u>도움말</u></Button>
              </Grid>
